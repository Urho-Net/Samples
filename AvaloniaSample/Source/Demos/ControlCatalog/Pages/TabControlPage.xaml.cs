...
namespace ControlCatalog.Pages
{
    ...
    public class TabControlPage : UserControl
    {
            ...
            DataContext = new PageViewModel
            {
                Tabs = new[]
                {
                    new TabItemViewModel
                    {
                        ...
                        Image = LoadBitmap("avares://Game/Source/Demos/ControlCatalog/Assets/delicate-arch-896885_640.jpg"),
                    },
                    new TabItemViewModel
                    {
                        Header = "Leaf",
                        Text = "This is the second templated tab page.",
                        Image = LoadBitmap("avares://Game/Source/Demos/ControlCatalog/Assets/maple-leaf-888807_640.jpg"),
                    },
                    new TabItemViewModel
                    {
                        Header = "Disabled",
                ...
                TabPlacement = Avalonia.Controls.Dock.Top,
            };
        }
        ...
        {
            private Avalonia.Controls.Dock _tabPlacement;

            public TabItemViewModel[] Tabs { get; set; }

            public Avalonia.Controls.Dock TabPlacement
            {
