...
namespace Urho.Gui
{
    ...
    class VGButton : UIElement
    {
        ...
        private   event Action<ClickEventArgs> _Click;


        public event Action<ClickEventArgs> OnClick
        {
            add
            {
                _Click += value;
        ...
        // List<Action<bool>> pressedList = new  List<Action<bool>> ();
        ...
        //   foreach (Delegate d in pressedList)
        //     {
                
        //         _OnPressed -= (Action<bool>)d;
        //     }
