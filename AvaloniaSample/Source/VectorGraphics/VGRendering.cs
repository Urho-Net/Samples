...
namespace Urho
{
    ...
    public static class VGRendering
    {
        ...
        // public static void drawRectDividers(VGFrameBuffer vge, Button button)
        // {
        //     IntRect rect = button.ImageRect;

        //     vge.StrokeColor(vge.RGBA(255, 255, 255, 255));
        //     vge.StrokeWidth(2f);
        //     vge.BeginPath();
        //     vge.Rect(rect.Left, rect.Top, rect.Right, rect.Bottom);
        //     vge.Stroke();
        // }
