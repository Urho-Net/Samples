...
namespace Urho.Gui
{
    public class  RegisterWindow : Window
    {
        ...
        public  RegisterWindow()
        {
            ...
            var windowTitle = new VGLabel(canvas, "New player","", Color.Yellow, new Color(0.4f, 0.3f, 0.6f, 1.0f));
            ...
            buttonLogin = new VGButton(canvas, "Register", "", new Color(0.5f, 0.5f, 0.5f, 1.0f), new Color(1.0f, 1.0f, 0.0f, 1.0f), 0.0f);
            buttonLogin.Click += OnButtonRegisterClick;
        ...
        private void OnButtonRegisterClick(ClickEventArgs obj)
        {
            Log.Info("Button register click");
        }
